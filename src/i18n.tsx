...
const resources = {
  en: {
    translation: {
      ...
      Function: 'Function',
      'Execute Query': 'Execute Query',
      'Prettify Request Editor': 'Prettify Request Editor',
      'Copy Query': 'Copy Query',
    },
  },
  ru: {
    translation: {
      ...
      'Short Key': 'Горячая клавиша',
      'Short Keys': 'Горячие клавиши',
      Function: 'Назначение',
      'Execute Query': 'Выполнить запрос',
      'Prettify Request Editor': 'Отформатировать редактор запроса',
      'Copy Query': 'Копировать запрос',
    },
  },
};
